...
public class ImportController extends BaseController {
    ...
    public ModelAndView importEmployeesConfirm(@RequestParam("employees") String employees) throws IOException {
    ...
    @PostMapping("/items")
    public ModelAndView importItemsConfirm(@RequestParam("items") String items) throws IOException {
